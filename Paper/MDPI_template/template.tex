...
\usepackage{natbib}
\usepackage{array} % For paragraph-like columns
\usepackage{svg}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{/home/zba21/Documents/ShallowLearn/Graphs/Spectral Responses of Sentinel-2A and Sentinel-2B.png}
...
\begin{small} % This command will make the text of the table smaller
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{/home/zba21/Documents/ShallowLearn/Paper/MDPI_template/Images/Satellite Image Visualization in Principal Component Space.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{/home/zba21/Documents/ShallowLearn/Graphs/silhouette_avg_scores.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.9\linewidth]{/home/zba21/Documents/ShallowLearn/Graphs/Feature_Map.pdf}
...
This is likely due to the distribution of the data being not normal. %% The best results are obtained using histogram matching and histogram equalisation, with histogram matching providing the best results overall. This is likely due to the fact that the data is not normally distributed and the histogram matching (Add this back into the chart - need a seperate workflow or fig)
...
% We generally find that the imagery is not always easily comparable through time, even using ratioing techniques we do not find clear repeatable clusters and will discuss this further in the discussion. 
